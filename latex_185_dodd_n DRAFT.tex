...
\begin{abstract}
%\boldmath
In this tutorial, I will go over the basics of \LaTeX\, its importance, why one should learn it and other general usages of it. \LaTeX\ is a professional documentation tool that engineers use to write up research papers, mathematically heavy documents and more.
\end{abstract}
...
\IEEEPARstart{T}{his} is a simple tutorial for using \LaTeX\. This program is extremely useful for engineers and programmers because of the capability it has compared to Notepad or Word. 
...
%\begin{IEEEbiography}{Nikhil Dodd}
%Biography text here.
%\end{IEEEbiography}
